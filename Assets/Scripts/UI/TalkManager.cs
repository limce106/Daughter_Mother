...
public class TalkManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Talk10.Add("사실 네가 가정을 꾸리고, 한 아이의 엄마가 되면서 어릴 적 너의 활기차고 장난기 있던 모습이 없어진 것처럼 보였어.");//17
        Talk10.Add("그래서 어린 시절 엄마와 " + PlayerPrefs.GetString("Name") + "이가 함께 했던 추억과 이 추억이 깃든 물건들을 보여준거야.");
        Talk10.Add("어린 시절 순수하고 활기찼던 " + PlayerPrefs.GetString("Name") + "이의 모습을 다시금 깨닫게 해주고 싶었어.");
        Talk10.Add("진정한 너의 모습 말이야."); //20
        // 플레이어
